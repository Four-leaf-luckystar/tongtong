(function () {
    ...
    const REFERENCE_DOCUMENT_HTML = [
    "<!DOCTYPE html>",
    "<html lang=\"zh-CN\">",
    "<head>",
    "    <meta charset=\"UTF-8\">",
    "    <meta name=\"viewport\" content=\"width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=no, viewport-fit=cover\">",
    "    <title>记忆库 UI - 个人主页风格</title>",
    "    <style>",
    "        /* ==========================================",
    "           iOS 原生设计系统变量",
    "           ========================================== */",
    ...
    "            --ios-bg: #FFFFFF;",
    "            --ios-card: #F6F6F6; ",
    "            --ios-btn-gray: rgba(142, 142, 147, 0.12); ",
    ...
    "            box-shadow: 0 0 0 12px #000, 0 20px 40px rgba(0,0,0,0.2);",
    "        }",
    "",
    "        /* 刘海 */",
    "        .notch {",
    "            position: absolute; top: 0; left: 50%; transform: translateX(-50%);",
    "            width: 150px; height: 32px; background: #000;",
    ...
    "        }",
    "        .avatar-switch-badge:active { transform: scale(0.9); }",
    "        .avatar-switch-badge svg { width: 14px; height: 14px; }",
    "",
    "        .profile-info {",
    "            margin-left: 18px;",
    "            display: flex;",
    ...
    "            color: var(--ios-text-primary);",
    "            font-weight: 600;",
    "            box-shadow: 0 3px 8px rgba(0,0,0,0.04), 0 1px 1px rgba(0,0,0,0.04);",
    "        }",
    "",
    "        /* ==========================================",
    "           iOS 原生搜索框 (Search Bar)",
    "           ========================================== */",
    "        .ios-search-bar {",
    "            padding: 0 20px;",
    "            margin-bottom: 20px;",
    ...
    "        }",
    "        .ios-list-title {",
    "            font-size: 18px; font-weight: 600; color: var(--ios-text-primary); margin: 0;",
    "        }",
    "        ",
    "        .ios-list-actions {",
    "            display: flex;",
    ...
    "        }",
    "        .icon-action-btn:active { opacity: 0.6; }",
    "        .icon-action-btn svg {",
    "            width: 20px; height: 20px; /* 稍微缩小一点图标以匹配文字大小 */",
    "        }",
    "",
    "        /* ==========================================",
    "           记忆列表卡片",
    ...
    "        }",
    "        .badge.summary { background: rgba(0, 122, 255, 0.12); color: var(--ios-blue); }",
    "        .badge.manual { background: rgba(52, 199, 89, 0.12); color: #28CD41; }",
    "",
    "        .memory-date { font-size: 13px; color: var(--ios-text-secondary); }",
    "",
    "        .memory-text {",
    "            font-size: 15px; line-height: 1.5; color: var(--ios-text-primary);",
    ...
    "        }",
    "        .modal-card-title { font-size: 17px; font-weight: 600; color: var(--ios-text-primary); margin: 0; }",
    "        .modal-card-subtitle { font-size: 14px; color: var(--ios-text-secondary); margin: 0; }",
    "",
    "        /* 取消按钮 */",
    "        .modal-cancel-btn {",
    ...
    "            font-size: 15px; font-weight: 500; color: var(--ios-text-primary);",
    ...
    "        </button>",
    "        <button class=\"btn-capsule\">设置</button>",
    "    </div>",
    "",
    "    <!-- 滚动内容区 -->",
    ...
    "                <div class=\"avatar-switch-badge\" onclick=\"openSwitcher()\">",
    "                    <svg xmlns=\"http://www.w3.org/2000/svg\" fill=\"none\" viewBox=\"0 0 24 24\" id=\"Arrow-Transfer-Horizontal-Large-1--Streamline-Sharp\" height=\"24\" width=\"24\">",
    "                      <g id=\"arrow-transfer-horizontal-large-1--arrow-server-arrows-data-horizontal-internet-transfer-network-large-head\">",
    "                        <path id=\"Union\" fill=\"#000000\" fill-rule=\"evenodd\" d=\"m20 10.75 3.0176 0 -7.5 -7.5h-2.0178l0 5 -12.499801 0 0 2.5L20 10.75Zm-9.4998 2.5L4 13.25l-3.017578 0 7.499998 7.5h2.01778l0 -5L23 15.75v-2.5l-12.4998 0Z\" clip-rule=\"evenodd\" stroke-width=\"1\"></path>",
    "                      </g>",
    "                    </svg>",
    "                </div>",
    "            </div>",
    ...
    "                <h1 class=\"profile-name\" id=\"mainProfileName\">速水沢</h1>",
    "                <p class=\"profile-stat-line1\">记忆总数：12 条</p>",
    "                <p class=\"profile-stat-line2\">共同对话：342 轮 &nbsp;|&nbsp; 认识天数：45 天</p>",
    "            </div>",
    "        </div>",
    "",
    "        <!-- 分段控制器 (Segmented Control) -->",
    "        <div class=\"segmented-control\">",
    "            <div class=\"segment-btn active\">记忆</div>",
    "            <div class=\"segment-btn\">关系</div>",
    "            <div class=\"segment-btn\">片段</div>",
    "            <div class=\"segment-btn\">档案</div>",
    "        </div>",
    "",
    "        <!-- iOS 原生搜索框 -->",
    ...
    "                    <span class=\"badge summary\">L2 摘要 · 近况</span>",
    "                    <span class=\"memory-date\">今天 09:41</span>",
    "                </div>",
    "                <p class=\"memory-text\">最近我们聊了很多关于未来旅行的计划，速水沢表示非常想去冰岛看极光，并且希望能在冬天成行。</p>",
    "            </div>",
    "",
    "            <div class=\"memory-card\">",
    "                <div class=\"memory-card-header\">",
    "                    <span class=\"badge manual\">手动记录</span>",
    "                    <span class=\"memory-date\">8月4日</span>",
    "                </div>",
    "                <p class=\"memory-text\">速水沢对海鲜过敏，以后一起吃饭的时候需要特别注意避开海鲜类食物。</p>",
    "            </div>",
    "        </div>",
    "    </div>",
    "",
    "    <!-- 屏幕中间的角色切换弹窗 -->",
    "    <div class=\"switcher-overlay\" id=\"switcherOverlay\" onclick=\"closeSwitcher(event)\">",
    "        <div class=\"modal-list-container\" onclick=\"event.stopPropagation()\">",
    "            <div class=\"modal-card\" onclick=\"selectCharacter('Evelyn')\">",
    "                <div class=\"modal-card-avatar\"></div>",
    "                <div class=\"modal-card-info\">",
    "                    <h3 class=\"modal-card-title\">Evelyn</h3>",
    "                    <p class=\"modal-card-subtitle\">共同记忆档案</p>",
    "                </div>",
    "            </div>",
    "            <div class=\"modal-card\" onclick=\"selectCharacter('Bob')\">",
    "                <div class=\"modal-card-avatar\"></div>",
    "                <div class=\"modal-card-info\">",
    "                    <h3 class=\"modal-card-title\">Bob</h3>",
    "                    <p class=\"modal-card-subtitle\">共同记忆档案</p>",
    "                </div>",
    "            </div>",
    "            <div class=\"modal-card\" onclick=\"selectCharacter('速水沢')\">",
    "                <div class=\"modal-card-avatar\"></div>",
    "                <div class=\"modal-card-info\">",
    "                    <h3 class=\"modal-card-title\">速水沢</h3>",
    "                    <p class=\"modal-card-subtitle\">共同记忆档案</p>",
    "                </div>",
    "            </div>",
    "        </div>",
    "        ",
    "        <button class=\"modal-cancel-btn\" onclick=\"closeSwitcher()\">取消</button>",
    "    </div>",
    "",
    "</div>",
    "",
    ...
    "",
    "    // 弹窗与角色切换交互逻辑",
    "    const overlay = document.getElementById('switcherOverlay');",
    ...
    async function decodeReferenceDocument() {
        return REFERENCE_DOCUMENT_HTML;
    }
